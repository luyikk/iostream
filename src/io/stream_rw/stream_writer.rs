...
impl<'a> StreamWriter<'a> {
    ...
    pub fn write_byte(&mut self, b: &u8) -> Result<(), Box<dyn Error>> {
    ...
    ///
    pub fn write_single(&mut self, value: &f32) -> Result<(), Box<dyn Error>> {
        let mut data: [u8; 4] = [0; 4];
    ...
    ///
    pub fn write_double(&mut self, value: &f64) -> Result<(), Box<dyn Error>> {
        let mut data: [u8; 8] = [0; 8];
    ...
    fn write_7bit_encode_int(&mut self, value: &u32) -> Result<(), Box<dyn Error>> {
    ...
    ///
    pub fn write_string(&mut self, value: &str) -> Result<(), Box<dyn Error>> {
    ...
    ///
    pub fn write_line(&mut self, value: &str) -> Result<(), Box<dyn Error>> {
    ...
    ///
    pub fn write_all_lines(&mut self, value: &[&str]) -> Result<(), Box<dyn Error>> {
        for i in value.iter() {
            self.write_line(i)?;
        }
        Ok(())
