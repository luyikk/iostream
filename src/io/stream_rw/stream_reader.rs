...
impl<'a>  StreamReader<'a >{
    ...
    pub fn from_big_endian(stream:&'a mut Stream)->Result<StreamReader<'a>,String> {
        ...
        Ok(StreamReader { base_stream: stream ,endian:EndianType::BigEndian})
    }

    /// peek the current stream next byte
    pub fn peek(&mut self)->Result<u8,String>{
        let d= self.base_stream.read_byte()?;
        let p=self.base_stream.position()-1;
        self.base_stream.set_position(p)?;
        Ok(d)
    }
    ...
    pub fn read_byte(&mut self)->Result<u8,String>{
         self.base_stream.read_byte()
    }

    ///read vec<u8> from stream,return read length
    pub fn read_all(&mut self,  buf: &mut Vec<u8> ) ->Result<usize,String>{
        self.base_stream.read_all(buf)
    }

    ///read [u8] from stream,can use offset and count buff position,return read len
    pub fn read(&mut self,buf:&mut [u8],offset:usize,count:usize)->Result<usize,String>{
        self.base_stream.read(buf,offset,count)
    }
    ...
    pub fn read_i16(&mut self)->Result<i16,String> {
        ...
        if r==2{
            ...
            Err(format!("read length error for i16,need length 2,read length {}",r))
        }
    ...
    pub fn read_u16(&mut self)->Result<u16,String> {
        ...
        if r==2{
            ...
            Err(format!("End"))
                ...
                Err(format!("read length error for u16,need length 2,read length {}",r))
            }
    ...
    pub fn read_u32(&mut self)->Result<u32,String> {
        ...
        if r==4{
            ...
            Err(format!("End"))
                ...
                Err(format!("read length error for u32,need length 4,read length {}",r))
            }
    ...
    pub fn read_i32(&mut self)->Result<i32,String> {
        ...
        if r == 4 {
            ...
            Err(format!("read length error for i32,need length 4,read length {}", r))
        }
    }
    ...
    pub fn read_i64(&mut self)->Result<i64,String> {
        ...
        if r == 8 {
            ...
            Err(format!("read length error for i64,need length 8,read length {}", r))
        }
    }
    ...
    pub fn read_u64(&mut self)->Result<u64,String> {
        ...
        if r == 8 {
            ...
            Err(format!("read length error for u64,need length 8,read length {}", r))
        }
    }
    ...
    ///
    pub fn read_single(&mut self)->Result<f32,String>{
        let mut data: [u8; 4] = [0; 4];
        let r = self.read(&mut data, 0, 4)?;
        ...
        if r == 4 {
            ...
            Err(format!("read length error for f32,need length 4,read length {}", r))
        }
    }
    ...
    pub fn read_double(&mut self)->Result<f64,String>{
        ...
        if r == 8 {
            ...
            Err(format!("read length error for f64,need length 8,read length {}", r))
        }
    }
    ...
    ///    assert_eq!(data[..],rt[..] );
    /// ```
    pub fn read_u8_array(&mut self,len:u32)->Result<Vec<u8>,String>{
